...
_SYSTEM_PROMPT = load_prompt("evaluator_http.txt")


def evaluate_http(result: CollectorResult, settings: Settings) -> EvaluatedFinding:
    """Evaluate HTTP security posture risk from a collector result."""
    data = call_llm(
