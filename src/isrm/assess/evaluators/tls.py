...
_SYSTEM_PROMPT = load_prompt("evaluator_tls.txt")


def evaluate_tls(result: CollectorResult, settings: Settings) -> EvaluatedFinding:
    """Evaluate TLS/certificate risk from a collector result."""
    data = call_llm(
