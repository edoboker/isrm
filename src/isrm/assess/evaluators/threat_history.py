...
_SYSTEM_PROMPT = load_prompt("evaluator_threat_history.txt")


def evaluate_threat_history(result: CollectorResult, settings: Settings) -> EvaluatedFinding:
    """Evaluate threat-history risk from a collector result."""
    data = call_llm(
